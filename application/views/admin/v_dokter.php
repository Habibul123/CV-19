        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add dokter</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                  <?php
                   foreach ($data->result_array() as $i) :
                       ...
                       $kota_id=$i['dokter_kota_id'];
                       $kota_nama=$i['dokter_nama'];
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                          <select name="xkota" class="form-control" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                          <select name="xkota" class="form-control" required>
                                            ...
                                            ?>
                                            <?php if($id_kota==$kota_id):?>
                                              <option value="<?php echo $id_kota;?>" selected><?php echo $nm_kota;?></option>
                                            <?php else:?>
                                              <option value="<?php echo $id_kota;?>"><?php echo $nm_kota;?></option>
                                            <?php endif;?>
                                            <?php } ?>
